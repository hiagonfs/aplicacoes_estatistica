...
hist(normal_media1, main="Histograma da Média Amostral da Distribuição Normal", col="aquamarine3", xlab= "Media Amostral", ylab= "Frequencia Relativa")
hist(median_dist1, main="Histograma da Mediana da Distribuição Normal", col="aquamarine3", xlab= "Media Amostral", ylab= "Frequencia Relativa")

hist(normal_media2, main="Histograma da Média Amostral da Distribuição Normal", col="brown2", xlab= "Media Amostral", ylab= "Frequencia Relativa")
hist(median_dist2, main="Histograma da Mediana da Distribuição Normal", col="brown2", xlab= "Media Amostral", ylab= "Frequencia Relativa")

hist(normal_media3, main="Histograma da Média Amostral da Distribuição Normal", col="red", xlab= "Media Amostral", ylab= "Frequencia Relativa")
hist(median_dist3, main="Histograma da Mediana da Distribuição Normal", col="red", xlab= "Media Amostral", ylab= "Frequencia Relativa")

hist(normal_media4, main="Histograma da Média Amostral da Distribuição Normal", col="lightcoral", xlab= "Media Amostral", ylab= "Frequencia Relativa")
hist(median_dist4, main="Histograma da Mediana da Distribuição Normal", col="lightcoral", xlab= "Media Amostral", ylab= "Frequencia Relativa")
